...
class KVCache:
    ...
    group_tags: list[str]
    group_is_state_cache: list[bool]
    group_is_fixed_cache: list[bool]
    group_skip_prefix_reuse: list[bool]
    layer_tag_to_group_id: list[dict[str, int]]
    kv_cache_base_by_layer_tag: list[dict[str, torch.Tensor]]
    kv_scale_base_by_layer_tag: list[dict[str, torch.Tensor]]
    def __init__(self) -> None: ...
    @typing.overload
    ...
    def get_layer_cache(self, arg0: int, arg1: str) -> LayerKVCache:
        """Return a raw per-layer LayerKVCache for the given global layer id and KV cache tag."""
        ...
    def get_layer_caches(self, arg0: int) -> list[LayerKVCache]:
        """Return all per-layer LayerKVCache views owned by the given global layer id."""
        ...
