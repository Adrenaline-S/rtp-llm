...
def h20_oss_suites():
    ...
    # Multi-pool production initialization intentionally fails fast in the coordinator.
    # Keep the direct connector coverage addressable without putting it in the default Next suite.
    native.test_suite(
        name = "smoke_h20_next_multi_pool_remote_manual",
        tests = [
            smoke_test(
