...
void WriteCacheStoreOp(const torch::Tensor&                         input_lengths,
    ...
    auto run = [captured_input_lengths,
        ...
        inputs.group_tokens_per_block                        = captured_cache_store.group_tokens_per_block;
        inputs.group_kv_block_stride_bytes                   = captured_cache_store.group_kv_block_stride_bytes;
        inputs.group_kv_scale_stride_bytes                   = captured_cache_store.group_kv_scale_stride_bytes;
        inputs.group_kv_block_transfer_bytes                 = captured_cache_store.group_kv_block_transfer_bytes;
        inputs.group_kv_scale_transfer_bytes                 = captured_cache_store.group_kv_scale_transfer_bytes;
        ...
        inputs.group_tokens_per_block[captured_kv_cache.tag] = layer_tokens_per_block;
