...
void WriteCacheStoreOp(const torch::Tensor&                         input_lengths,
    ...
    auto run = [captured_input_lengths,
        ...
        CacheStoreInputs inputs{captured_input_lengths,
                                ...
                                captured_kv_cache.cache_tag,
                                captured_kv_cache.group_id >= 0
                                    && static_cast<size_t>(captured_kv_cache.group_id)
                                           < captured_cache_store.group_is_fixed_cache.size()
                                    && captured_cache_store.group_is_fixed_cache
                                           [static_cast<size_t>(captured_kv_cache.group_id)],
