...
void runtimeWriteCacheStore(const CacheStoreInputs&     cache_store_inputs,
    ...
    RTP_LLM_CHECK_WITH_INFO(!use_group_cache_transfer_policy || seq_it != param.tokens_per_block_by_tag.end(),
    ...
    RTP_LLM_CHECK_WITH_INFO(!use_group_cache_transfer_policy
                                || kv_stride_it != param.kv_block_stride_bytes_by_tag.end(),
    ...
    RTP_LLM_CHECK_WITH_INFO(!use_group_cache_transfer_policy
                                || scale_stride_it != param.kv_scale_stride_bytes_by_tag.end(),
    ...
    RTP_LLM_CHECK_WITH_INFO(!use_group_cache_transfer_policy
                                || kv_transfer_it != param.kv_block_transfer_bytes_by_tag.end(),
    ...
    RTP_LLM_CHECK_WITH_INFO(!use_group_cache_transfer_policy
                                || scale_transfer_it != param.kv_scale_transfer_bytes_by_tag.end(),
