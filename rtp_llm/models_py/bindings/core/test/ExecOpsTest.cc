...
static torch_ext::PyCacheStoreInputs makePyCacheStoreInputs(const std::shared_ptr<MockCacheStore>& cache_store,
    ...
    inputs.group_tokens_per_block        = {{"default", tokens_per_block}};
    inputs.group_kv_block_stride_bytes   = {{"default", kv_stride}};
    inputs.group_kv_scale_stride_bytes   = {{"default", scale_stride}};
    inputs.group_kv_block_transfer_bytes = {{"default", kv_stride}};
    inputs.group_kv_scale_transfer_bytes = {{"default", scale_stride}};
...
TEST_F(ExecOpsTest, testWriteCacheStoreSharedPoolUsesPhysicalBlockStrideInsteadOfLayerViewStride) {
    ...
    inputs.group_tokens_per_block        = {{"full", physical_tokens_per_block}, {"linear", physical_tokens_per_block}};
    inputs.group_kv_block_stride_bytes   = {{"full", pool_block_stride}, {"linear", pool_block_stride}};
    inputs.group_kv_scale_stride_bytes   = {{"full", 0}, {"linear", 0}};
    inputs.group_kv_block_transfer_bytes = {{"full", pool_block_stride}, {"linear", layer_view_stride}};
    inputs.group_kv_scale_transfer_bytes = {{"full", 0}, {"linear", 0}};
