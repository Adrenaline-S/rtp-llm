...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<LayerKVCache>(m, "LayerKVCache")
        ...
        .def_readonly("cache_tag", &LayerKVCache::cache_tag, "KV cache semantic tag");
    ...
    pybind11::class_<KVCache>(m, "KVCache")
        ...
        .def_readwrite("group_tags", &KVCache::group_tags, "Per-group semantic KV cache tags")
        .def_readwrite("group_is_state_cache", &KVCache::group_is_state_cache, "Per-group state-cache flag")
        .def_readwrite("group_is_fixed_cache", &KVCache::group_is_fixed_cache, "Per-group fixed-cache flag")
        .def_readwrite("group_skip_prefix_reuse",
                       &KVCache::group_skip_prefix_reuse,
                       "Per-group prefix-reuse skip flag")
        ...
        .def_readwrite("layer_tag_to_group_id",
                       ...
                       "Mapping from layer id and semantic cache tag to group id")
        .def_readwrite("kv_cache_base_by_layer_tag",
                       &KVCache::kv_cache_base_by_layer_tag,
                       "Per-layer and per-tag KV cache tensors")
        .def_readwrite("kv_scale_base_by_layer_tag",
                       &KVCache::kv_scale_base_by_layer_tag,
                       "Per-layer and per-tag KV scale tensors")
        .def("get_layer_cache",
        ...
        .def("get_layer_cache",
             pybind11::overload_cast<int, const std::string&>(&KVCache::getLayerCache),
             "Return a raw per-layer LayerKVCache for the given global layer id and semantic KV cache tag")
        ...
        .def("get_raw_pool_tensor",
             ...
             "Return raw [total_blocks, stride_bytes] tensor for a specific layer and semantic tag, no reshape");
