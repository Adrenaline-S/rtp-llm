...
class AttentionImplWithParams(Protocol):
    @property
    def fmha_params(self) -> object | None: ...
...
def get_fmha_params(
    fmha_impl: AttentionImplWithParams
    | Mapping[str, AttentionImplWithParams]
    | None,
) -> object | None:
