...
class DSv4DecodeFmhaImplFP8:
    ...
    def __init__(
        ...
        self._paged_entries_per_block: Dict[str, int] = {
            tag: spec[0] for tag, spec in config.paged_pool_specs.items()
        }
        self._paged_tokens_per_block: Dict[str, int] = {
            tag: spec[1] for tag, spec in config.paged_pool_specs.items()
        }
