...
public:
    CudaGraphRunner(const GraphParams& graph_params, py::object py_instance):
        ...
        physical_tokens_per_block_by_tag_(graph_params.physical_tokens_per_block_by_tag),
        kernel_tokens_per_block_by_tag_(graph_params.kernel_tokens_per_block_by_tag),
...
private:
    ...
    std::map<std::string, size_t>         physical_tokens_per_block_by_tag_;
    std::map<std::string, size_t>         kernel_tokens_per_block_by_tag_;
