...
inline PyWrappedModel::PyWrappedModel(const GptModelInitParams& params,
    ...
    if (params.kv_cache_layer_layout.has_value()) {
        ...
        kv_cache.group_is_state_cache          = layout.group_is_state_cache;
        kv_cache.group_is_fixed_cache          = layout.group_is_fixed_cache;
        kv_cache.group_skip_prefix_reuse       = layout.group_skip_prefix_reuse;
        ...
        kv_cache.kv_cache_base_by_layer_tag = layout.layers_to_kv_buffer_ptrs_by_tag;
        kv_cache.kv_scale_base_by_layer_tag = layout.layers_to_scale_buffer_ptrs_by_tag;
