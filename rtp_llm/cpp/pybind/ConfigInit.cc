...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<ParallelismConfig>(m, "ParallelismConfig")
        ...
        .def("local_kv_cache_sharding_enabled", &ParallelismConfig::localKvCacheShardingEnabled)
        .def("kv_cache_key_cp_size", &ParallelismConfig::kvCacheKeyCpSize)
        .def("validate_kv_cache_sharding", &ParallelismConfig::validateKvCacheSharding)
