...
public:
    ...
    virtual void removeSkippedBlocks(GroupBlockToPoolBlockBinding& binding,
                                     bool                          enable_reuse_cache = false,
                                     int                           reserve_step       = 0)                                  = 0;
    ...
    virtual void reference(GroupBlockToPoolBlockBinding& binding, const BlockIndicesType& new_block_indices)       = 0;
