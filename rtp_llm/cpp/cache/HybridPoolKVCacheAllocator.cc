...
const GroupBase& HybridPoolKVCacheAllocator::defaultGroupForLayer(int layer_id) const {
...
const GroupBase& HybridPoolKVCacheAllocator::validateGroupForLayer(int layer_id, std::string_view tag) const {
