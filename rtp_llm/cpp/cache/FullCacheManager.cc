...
bool FullCacheManager::malloc(GroupBlockToPoolBlockBinding& binding,
                              int                           seq_len,
                              bool                          enable_reuse_cache,
                              int                           reserve_step,
...
void FullCacheManager::reference(GroupBlockToPoolBlockBinding& binding, const BlockIndicesType& new_block_indices) {
...
void FullCacheManager::removeSkippedBlocks(GroupBlockToPoolBlockBinding& /*binding*/,
                                           bool /*enable_reuse_cache*/,
                                           int /*reserve_step*/) {}
