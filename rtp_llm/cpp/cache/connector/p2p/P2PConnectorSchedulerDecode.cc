...
P2PConnectorSchedulerDecode::AsyncReadResult P2PConnectorSchedulerDecode::asyncRead(
    ...
    auto selections =
        LayerCacheBufferUtil::selectBlocks(cache_config_, *resource, block_range.first, block_range.second);
    auto layer_cache_buffers = LayerCacheBufferUtil::convertBySelections(cache_config_, *resource, 0, selections);
