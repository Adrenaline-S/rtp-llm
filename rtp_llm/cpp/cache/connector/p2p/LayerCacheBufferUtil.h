...
public:
    static NativeTransferSelection                        selectBlocksForTag(const CacheConfig&     config,
                                                                             ...
                                                                             int                    cp_rank   = 0,
                                                                             int                    cp_size   = 1);
    static NativeTransferSelections                       selectBlocks(const CacheConfig&     config,
                                                                       const KVCacheResource& resource,
                                                                       int                    start_key_ordinal = 0,
                                                                       int                    key_count         = -1,
                                                                       int                    cp_rank           = 0,
                                                                       int                    cp_size           = 1);
    static std::vector<std::shared_ptr<LayerCacheBuffer>> convertBySelections(
