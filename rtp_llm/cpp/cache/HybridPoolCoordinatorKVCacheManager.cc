...
size_t CoordinatorKVCacheManager::minGroupTokens(CapacityScope scope, bool use_available_blocks) const {
    const auto in_scope = [this, scope](const GroupTopology& group) {
        switch (scope) {
...
size_t CoordinatorKVCacheManager::maxAvailableTokensNum() const {
...
HybridPoolCoordinatorKVCacheManager::HybridPoolCoordinatorKVCacheManager(
    ...
    CoordinatorKVCacheManager(config, allocation_type, metrics_reporter, reserve_block_ratio) {}
