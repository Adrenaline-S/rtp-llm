...
grpc::Status DecodeRpcServer::RemoteLoad(grpc::ServerContext*          server_context,
    ...
    TaggedBlockIdsMap         block_ids_by_tag = decodeGroupBlockIds(*request, topology);
...
DecodeRpcServer::TaggedBlockIdsMap DecodeRpcServer::decodeGroupBlockIds(const BroadcastLoadRequestPB& request,
